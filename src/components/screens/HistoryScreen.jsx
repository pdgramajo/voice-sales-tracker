            ...
            <li key={index} className="historial-item">
              <div className="historial-info">
                ...
                <span className="historial-detalles">
                  Ventas: {formatCurrency(item.totalSalesAmount)} | Gastos: {formatCurrency(item.totalExpenses)}
                </span>
              </div>
              <span className={`historial-ganancia ${item.cashInDrawer >= 0 ? 'positive' : 'negative'}`}>
